      ...
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        {{-- <img src="#" class="mr-5 h-6 sm:h-9" alt="logo" /> --}}
          ...
          <div class="flex mt-8 space-x-6 text-white">
            ...
            <a class="hover:opacity-75" href="https://github.com" target="_blank" rel="noreferrer">
            ...
            <a class="hover:opacity-75" href="https://dribbble.com" target="_blank" rel="noreferrer">
        ...
        <div class="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <nav class="flex flex-col mt-4 space-y-2 text-sm text-white">
              ...
              <a class="hover:opacity-75" href ="#service"> Service </a>
            </nav>
          </div>
          <div>
            <p class="font-medium text-yellow-500">
            ...
            <nav class="flex flex-col mt-4 space-y-2 text-sm text-white">
              ...
              <a class="hover:opacity-75" href =#product>4 Wheeler Battery </a>
              <a class="hover:opacity-75" href =#product>more than 4 Wheeler Battery </a>
            </nav>
          </div>
          <div>
            <p class="font-medium text-yellow-500">
