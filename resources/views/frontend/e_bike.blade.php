...
<main class="container mx-auto py-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 m-4 gap-6">
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <a href="{{route('productdetail')}}"><img src="{{asset('assets/image/ebike.jpeg')}}" alt="Product" class="w-full"></a>
            <div class="p-4">
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <img src="{{asset('assets/image/ebike.jpeg')}}" alt="Product" class="w-full">
            <div class="p-4">
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="p-4">
                <h3 class="font-bold text-lg">Fosna Ragnar</h3>
                <p class="text-gray-600">€4,419.00 EUR</p>
                <a href="{{route('productdetail')}}">  <button class="border border-[#75CDD8] text-center p-2 m-2 text-[#75CDD8]">View details</button></a>
            </div>
        </div>
